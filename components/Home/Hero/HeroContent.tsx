...
const HeroContent = () => {
    return (
        <div>
            <h1 data-aos='fade-right' className='text-2xl sm:text-4xl md:text-5xl lg:text-4xl xl:text-7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white '>Explore, Learn, and Master the Art of Cooking with Us!</h1>
            ...
            <div className='mt-8 flex items-center space-x-4'>
                ...
                <button data-aos = 'zoom-in' data-aos-delay = '450' className='button_cls bg-yellow-700 hover:bg-yellow-900'>
                    Learn More
                </button>
            </div>
